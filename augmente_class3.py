...
input_dir = r'C:\Users\ADMIN\Documents\Project updated\aptos-augmented-images\valid\retina\3'   # Folder with 1433 images for class 0
output_dir = r'C:\Users\ADMIN\Documents\Project updated\aptos-augmented-images\valid\retina\3'  # Same folder (overwrite mode)
...
print(f"Current images in class 3: {current_count}")
augmented_count = 0
i = 0
